...
export default function StaffDesktopDashboardPage() {
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <p className="text-white text-sm font-medium">Staff Member</p>
            <p className="text-white/40 text-xs">Housekeeping</p>
          </div>
          <div className="w-10 h-10 rounded-full bg-heritage-gold flex items-center justify-center text-heritage-charcoal font-bold text-sm">
            S
          </div>
        </div>
      </div>
